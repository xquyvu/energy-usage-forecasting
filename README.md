...
The best model generated by AutoML is a SoftVottingRegressor, which is an ensemble of 4 models: 3 `XGBoostRegressor`s, and 1 `LassoLars`. Details of the estimators are as follows:
...
| `spearman_correlation`                   | 0.861     |
| `mean_absolute_error`                    | 30766.873 |
| `median_absolute_error`                  | 22727.317 |
| `explained_variance`                     | 0.748     |
| `mean_absolute_percentage_error`         | 12.040    |
| `root_mean_squared_log_error`            | 0.172     |
| `normalized_root_mean_squared_error`     | 0.095     |
| `normalized_median_absolute_error`       | 0.049     |
| `root_mean_squared_error`                | 44143.202 |
| `r2_score`                               | 0.748     |
| `normalized_mean_absolute_error`         | 0.066     |
